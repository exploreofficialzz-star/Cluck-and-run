      ...
      child: Center(
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [Color(0xFF0d1117), Color(0xFF1a1f2e)],
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            // Chicken image paused
            Image.asset(kImgChicken, width: 72, height: 72, fit: BoxFit.contain),
            const SizedBox(height: 8),
            const Text('PAUSED', style: TextStyle(color: Colors.white, fontSize: 26,
